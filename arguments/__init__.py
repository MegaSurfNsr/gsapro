...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.percent_dense = 0.001 # 0.001
        self.lambda_dssim = 0.2
        self.densification_interval = 100 # 500
        self.opacity_reset_interval = 3000
        self.densify_from_iter = 500 # 500
        self.densify_until_iter = 15_000
        self.densify_grad_threshold = 0.0002  # 0.0001
        ...
        self.multi_view_ncc_weight = 0.15 *0.1 # 0.15
        self.multi_view_geo_weight = 0.03 *0.1 # 0.03
        ...
        self.abs_split_radii2D_threshold = 20 # 20
        self.max_abs_split_points = 50_000
        self.max_all_points = 4_000_000
