...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from,
    ...
    for iteration in range(first_iter, opt.iterations + 1):
            ...
            if iteration in helix_iterations or iteration == opt.iterations:
                ...
                if iteration in helix_iterations:
                    ...
                    for i in range(helixncc.n_image):
                        print('pause')
                        fmask = helixncc.filter_depth_mask[i]
                        helixncc.depths[i][torch.logical_not(fmask)] = -1
        ...
        with torch.no_grad():
            ...
            if opt.use_multi_view_trim and iteration % 2000 == 0 and iteration < opt.densify_until_iter:
                observe_the = 2
...
if __name__ == "__main__":
    ...
    parser.add_argument('--port', type=int, default=6209)
    ...
    parser.add_argument("--save_iterations", nargs="+", type=int, default=[3000,6999,7001, 10000,30000])
    parser.add_argument("--helix_iterations", nargs="+", type=int, default=[30010])
    ...
    parser.add_argument('--ncc_pthred', default=0.4, type=float)
    ...
    for i in tqdm(range(helixncc.n_image)):
        ...
        # if args.save_helix or args.onlyncc:
