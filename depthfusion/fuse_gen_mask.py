...
def load_data_dtu(cam_path, helixout_path, image_path, rgb_flag=False):
    '''
...
def main():
    ...
    blendedpm_dir = '/mnt/data4/yswangdata4/dataset/dataset_low_res_patchmatch'
    dtupm_dir = '/mnt/data4/yswangdata4/dataset/dtu_patchmatch'

    blendedgt_dir = '/mnt/data3/yswang2024_data3/dataset/dataset_low_res'
    ...
    #     renewlist = renewlist + f.readlines()
    # with open('/mnt/data3/yswang2024_data3/dataset/blended_highres/process_scene','r') as f:
    #     renewlist = renewlist + f.readlines()
    # renewlist = [s.strip() for s in renewlist]
    # res_scenelist = []
    # for scene in renewlist:
    #     if scene not in blended_scenelist:
    #         res_scenelist.append(scene)
    # blended_scenelist = res_scenelist
    ...
    with open('/mnt/data4/yswangdata4/dataset/DTU/scan_list_test.txt', 'r') as f:
        dtu_scenelist = f.readlines()
        dtu_scenelist = [c.strip() for c in dtu_scenelist]

    blended_save = '/mnt/data4/yswangdata4/experiments/multiview_filter/blended_new_high'
    dtu_save = '/mnt/data4/yswangdata4/experiments/multiview_filter/dtu_high'
    ...
    # for blended:
    for scene in blended_scenelist:
        # args.dist_thresh = 0.05
        # args.dist_thresh_downsample = 0.05

        os.makedirs(os.path.join(blended_save, scene), exist_ok=True)
        print(scene)
        cams_path = os.path.join(blendedgt_dir,scene,'cams')
        image_path = os.path.join(blendedgt_dir,scene,'blended_images')
        hypos_path = os.path.join(blendedpm_dir,scene, 'patchmatch')
        cmd = [cams_path,image_path,hypos_path,os.path.join(blended_save, scene)]
        ...
        args.dist_thresh = depths.max() * acc_pthred
        args.dist_thresh_downsample = depths.max() * acc_pthred
    ...
    #     os.makedirs(os.path.join(dtu_save, scene), exist_ok=True)
    #     print(scene)
    ...
    #     cmd = [cams_path,image_path,hypos_path,os.path.join(dtu_save, scene)]
    #
    #     args.cam_path = cmd[0]
    #     args.image_path = cmd[1]
    #     args.helixout_path = cmd[2]
